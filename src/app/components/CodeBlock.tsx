...
const LITERALS = new Set<string>(["true", "false", "null", "undefined", "NaN", "Infinity", "BigInt"]);
...
const TYPESCRIPT_TYPES = new Set<string>([
  "string",
  "number",
  "boolean",
  "any",
...
type TokenType = "plain" | "comment" | "string" | "number" | "keyword" | "literal" | "builtin" | "type";
...
type CodeLanguage = "javascript" | "typescript" | (string & {});
